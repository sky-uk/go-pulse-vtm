...
func init() {
	...
	updateVirtualServerFlags.BoolVar(&updateVirtualServerListenAny, "listen-on-any", false, "usage: -listen-on-any (Default: false)")
	...
	updateVirtualServerFlags.BoolVar(&updateVirtualServerEnabled, "enabled", false, "usage: -enabled (Default: false)")
	updateVirtualServerFlags.BoolVar(&updateVirtualServerKeepalive, "keepalive", false, "usage: -keepalive (Default: false")
	updateVirtualServerFlags.UintVar(&updateVirtualServerObject.Properties.Basic.Port, "port", 80, "usage: -port xx (Default: 80)")
	updateVirtualServerFlags.UintVar(&updateVirtualServerObject.Properties.Connection.KeepaliveTimeout, "keepalive-timeout", 10, "usage: -keepalive-timeout xx (Default: 10)")
	updateVirtualServerFlags.UintVar(&updateVirtualServerObject.Properties.Connection.Timeout, "connection-timeout", 40, "usage: -connection-timeout xx (Default: 40)")
