...
func init() {
	...
	createVirtualServerFlags.BoolVar(&createVirtualServerListenAny, "listen-on-any", false, "usage: -listen-on-any (Default: false)")
	...
	createVirtualServerFlags.BoolVar(&createVirtualServerEnabled, "enabled", false, "usage: -enabled (Default: false)")
	createVirtualServerFlags.BoolVar(&createVirtualServerKeepalive, "keepalive", false, "usage: -keepalive (Default: false")
	createVirtualServerFlags.UintVar(&createVirtualServerObject.Properties.Basic.Port, "port", 80, "usage: -port xx (Default: 80)")
	createVirtualServerFlags.UintVar(&createVirtualServerObject.Properties.Connection.KeepaliveTimeout, "keepalive-timeout", 10, "usage: -keepalive-timeout xx (Default: 10)")
	createVirtualServerFlags.UintVar(&createVirtualServerObject.Properties.Connection.Timeout, "connection-timeout", 40, "usage: -connection-timeout xx (Default: 40)")
