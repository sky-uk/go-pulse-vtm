...
func setupVirtualServerTest() {
	...
	testVirtualServerMarshalExpectedJSON = `{"properties":{"basic":{"enabled":false,"pool":"test-pool","port":80,"protocol":"http"},"aptimizer":{},"connection":{},"connection_errors":{},"cookie":{},"dns":{},"ftp":{},"gzip":{},"ssl":{}}}`
