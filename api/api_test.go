...
func TestSetAndDelete(t *testing.T) {
	...
	assert.Equal(t, float64(10), basic["connect_timeout"])
	...
	assert.Equal(t, float64(20), basic["connect_timeout"])
